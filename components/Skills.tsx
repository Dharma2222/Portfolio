...
const defaultGridCategories: SkillCategory[] = [
  { title: 'Languages', skills: [
    ...
    { name: 'C++', icon: Box, color: '#1572B6' },
  ]},
  { title: 'Frontend', skills: [
    { name: 'React', icon: Code2, color: '#61DAFB' }, 
    { name: 'Next.js', icon: Layers, color: '#000000' },
    { name: 'Tailwind CSS', icon: Box, color: '#06B6D4' }, 
    { name: 'Redux / Zustand', icon: Layers, color: '#764ABC' },
    { name: 'Design Systems / UI', icon: Box, color: '#FF6B6B' }, 
    { name: 'Web Vitals & A11y', icon: Cpu, color: '#4ECDC4' },
  ]},
  { title: 'Backend', skills: [
    { name: 'Node.js', icon: Server, color: '#339933' }, 
    { name: 'Express / Nest', icon: Server, color: '#000000' },
    { name: 'REST APIs', icon: Code2, color: '#25D366' }, 
    { name: 'GraphQL', icon: Code2, color: '#E10098' },
    { name: 'Java (Spring Boot)', icon: Layers, color: '#FF9500' }, 
    { name: 'SQL / NoSQL', icon: Database, color: '#4DB33D' },
  ]},
  { title: 'Cloud and DevOps', skills: [
    { name: 'AWS', icon: Cloud, color: '#FF9900' }, 
    { name: 'Serverless (Lambda)', icon: Cloud, color: '#FF6B35' },
    { name: 'Docker', icon: Box, color: '#2496ED' }, 
    { name: 'CI/CD Pipelines', icon: GitBranch, color: '#4C8CBF' },
    { name: 'Infrastructure as Code', icon: GitBranch, color: '#623CE4' }, 
    { name: 'Monitoring & Logs', icon: Cpu, color: '#00D9FF' },
  ]},
  { title: 'Testing', skills: [
    ...
    { name: 'Design quality: Designite', icon: Cpu, color: '#9B59B6' },
  ]},
  { title: 'AI / ML', skills: [
    { name: 'Python (ML)', icon: Brain, color: '#3776AB' }, 
    { name: 'TensorFlow / PyTorch', color: '#FF6F00' },
    { name: 'LLMs / Prompting', icon: Code2, color: '#10A37F' }, 
    { name: 'RAG / Vector DBs', icon: Database, color: '#E25A3B' },
    { name: 'LangChain / OpenAI SDK', icon: Braces, color: '#412991' }, 
    { name: 'Data Pipelines', icon: GitBranch, color: '#FF4B4B' },
  ]},
