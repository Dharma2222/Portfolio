...
export default function Terminal(): JSX.Element {
  ...
  const aboutLines = useMemo(
    () => [
      "I'm Dharma Kevadiya and I am a software engineer passionate about building scalable web applications and cloud-native solutions.",
      "With expertise in Java/Spring Boot, Node.js/TypeScript, React/Next.js, and I deploy on AWS with serverless, Docker, and CI/CD. I focus on creating clean, well-tested code that solves real problems.",
      "",
      "When I'm not coding, you can find me exploring Halifax's tech scene, contributing to open source projects,",
      "or learning about the latest developments in cloud computing and serverless architecture.",
    ],
    []
  );
      ...
      <div className="rounded-2xl shadow-xl ring-1 ring-black/10 overflow-hidden bg-zinc-900">
        ...
        <div className="font-mono text-sm leading-relaxed text-zinc-100 px-4 py-5 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.06),transparent_60%)]">
          <div className="flex flex-wrap items-baseline">
            <span className="text-emerald-400">dharma@halifax</span>
